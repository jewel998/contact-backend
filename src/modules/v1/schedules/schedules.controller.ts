...
export class SchedulesController {
  ...
  @ApiResponse({ status: 200, description: 'A list of schedules.', type: [Schedule] })
  ...
  @ApiResponse({ status: 200, description: 'The schedule details.', type: Schedule })
  ...
  @ApiResponse({ status: 404, description: 'Schedule not found.' })
  async update(@Param('id') id: string, @Body() updateScheduleDto: UpdateScheduleDto): Promise<Schedule | null> {
